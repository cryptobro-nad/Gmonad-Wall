...
export function MessageCard({ post, isNewest }: Props) {
  ...
  return (
    <div
      className={`relative bg-gray-900 border-2 ${accent.border} rounded-xl p-4 pt-4 flex flex-col justify-between gap-1 ${rotation} hover:-translate-y-1 hover:shadow-xl transition-all duration-200`}
    >
      {/* pin dot */}
